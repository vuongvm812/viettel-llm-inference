...
// -> 256 threads x ITEMS=1; hidden=12288 -> 512 threads x ITEMS=3. Every quant shape we ship
...
// nvec up to 4*512 = 2048 (hidden up to 16384 at kVec=8) -- past any shape we expect.
