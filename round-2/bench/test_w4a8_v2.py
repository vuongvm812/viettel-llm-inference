...
# EXAMPLE (N, K) linear shapes in the layer's own orientation: N = out features. These are
# the tile-schedule sweep points, not a claim about any particular model -- boot the server and
# read the "w4a8 observed shape keys" log line, then put THIS model's shapes here.
#   3072x2048   attn qkv          2048x2048   attn out_proj
#   16384x2048  mlp w13           2048x8192   mlp w2   (the deep-wave Stream-K case)
#   6144x2048   a wide in_proj    65536x2048  lm_head
