...
Fairness notes (see docs/design/benchmark/design.md):
  - Weights: both sides must run the SAME model at the same precision. Precision matching is
    necessary but not sufficient — spot-check a few outputs, not just latency.
