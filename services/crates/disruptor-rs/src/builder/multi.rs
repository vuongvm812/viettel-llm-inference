...
use crate::{
    ...
    consumer::{
        MultiConsumerBarrier, SingleConsumerBarrier,
        event_poller::{Branch, EventPoller},
    },
    producer::multi::{MultiProducer, MultiProducerBarrier},
    wait_strategies::WaitStrategy,
};

use super::{Builder, MC, NC, SC, Shared};
    ...
    B: 'static + Barrier,
{
    ...
    pub fn join<B2>(
        mut self,
        branch: Branch<E, B2>,
    ) -> (EventPoller<E, B2>, MPBuilder<SC, E, W, B>) {
    ...
    B: 'static + Barrier,
{
    ...
    pub fn join<B2>(
        mut self,
        branch: Branch<E, B2>,
    ) -> (EventPoller<E, B2>, MPBuilder<MC, E, W, B>) {
        self.add_cursor_from_branch(&branch);
