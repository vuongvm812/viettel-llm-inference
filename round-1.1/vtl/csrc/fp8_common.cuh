...
// per-token quant (o_proj / down_proj-quant-half), the fused SiLU-mul quant, and the GDN
// gated-RMSNorm all share ONE copy of: the fp8 constants, the 16-byte vector types, the
