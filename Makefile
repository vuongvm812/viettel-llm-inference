...
check:
	...
	PYTHONPATH=. python3 vtl/_prefix.py
...
KERNEL_TESTS := /bench/test_rms_norm_quant.py /bench/test_dynamic_per_token_quant.py \
                ...
                /bench/test_gdn_gated_rmsnorm.py /bench/test_gdn_causal_conv1d.py \
                /bench/test_gdn_chunk_scan.py /bench/test_gdn_recurrent_decode.py
